...
class NetUtil {
  ...
  static Future _request(String url,
      {data, queryParameters, method = 'GET'}) async {
    var result;
    try {
  ...
  static Future get(String url, {Map<String, dynamic> queryParameters}) {
    queryParameters = queryParameters ?? {};
    return _request(url, data: {}, queryParameters: queryParameters);
  }
}
...
class BaseError {
  ...
  BaseError(this.errorCode, this.errorMsg);
}
